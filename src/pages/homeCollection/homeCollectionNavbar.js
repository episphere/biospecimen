export const homeCollectionNavbar = () => {
    ...
    template += `
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#printaddresses" id="printAdresses">Print Adresses</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#participantselection" id="participantSelection">Participant Selection</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#participantassignmen" id="participantAssignment">Participant Assignment</a>
                    </li>
                    <li class="nav-item">
