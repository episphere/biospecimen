    ...
    template += `
        ...
        <div class="row">
            ...
            <form id="finalizeForm" method="POST">
                ...
                <div class="form-group row">
                    <div class="col-auto">
                        <button class="btn btn-outline-danger" type="button" data-connect-id="${data.Connect_ID}" id="returnToCollectProcess" data-master-specimen-id="${specimenData['820476880']}">${getWorflow() === 'research' ? 'Return to Collect/Process' : 'Return to Labeling and Receipt'}</button>
                    </div>
                    <div class="ml-auto">
