            ...
            <table class="table table-bordered table-striped">
                ...
                collections.forEach(collection => {
                    template += `<tr>
                        ...
                        <td><button class="custom-btn continue-collect-process" data-connect-id="${data.Connect_ID}" data-collection-id="${collection['820476880']}">${getWorflow() === 'research' ? `Continue to Collect/Process`:`Continue to Labeling and Scanning`}</button></td>
                    </tr>`
                })
